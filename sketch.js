...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("red", "yellow");
  box2.display("red", "yellow");
  box3.display("red", "yellow");
  box4.display("red", "yellow");
  box5.display("red", "yellow");
  box6.display("red", "yellow");
  box7.display("red", "yellow");
  box8.display("red", "yellow");
  box9.display("red", "yellow");
  box10.display("red", "yellow");
  box11.display("red", "yellow");
  box12.display("red", "yellow");
  box13.display("red", "yellow");
  box14.display("red", "yellow");
  box15.display("red", "yellow");
